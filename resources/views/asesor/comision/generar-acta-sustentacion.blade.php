<x-app-layout>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Generar acta de sustentación</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form class="max-w-lg mx-auto" method="post" action="{{route('asesor.comision.generateActaSustentacion',['practicante'=>$practicante])}}">
                @csrf
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="mb-5">
                        <label for="nota_n" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nota en números</label>
                        <input type="number" id="nota_n" name="nota_n" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                    </div>
                    <div class="mb-5">
                        <label for="nota_l" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nota en letras</label>
                        <input type="text" id="nota_l" name="nota_l" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                    </div>
                </div>
