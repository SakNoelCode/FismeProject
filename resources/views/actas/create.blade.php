<x-app-layout>
    <div class="py-8">
        <div class="mx-auto sm:px-4 py-10 bg-slate-300 mr-14 ml-14 rounded-2xl">
            <div class="mb-4">
                <h1><strong style="color: blue">FORMULARIO PARA REGISTRAR ACTAS </strong></h1>
            </div>
            ...
            @csrf
                <div class="row">
                    <div class="grid gap-7 mb-6 ">
                        <div>
                            <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Título: <small style="color: rgb(5, 68, 241)">( Campo Obligatorio)</small></label>
                        ...
                        <div>
                            <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Estado: <small style="color: rgb(5, 68, 241)">( Campo Obligatorio)</small></label>
                ...
                <div class="grid gap-6 mb-6">
                    <div>
                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Observaciones <small style="color: rgb(5, 68, 241)">( Campo Obligatorio)</small></label>
                        <input type="text" name="observaciones" maxlength="10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="registrar aquí" required>
                    </div>
                    <div>
