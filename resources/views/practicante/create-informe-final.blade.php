...
<div class="bg-blue-600/30 rounded-xl px-5 sm:px-10 py-4 relative mb-6">
    <form action="{{route('practicante.store-designacion-jurado')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-6 lg:space-y-0">
                ...
                <div>
                    <div class="mt-6">
                        <a target="_blank" href="{{route('practicante.vista-generar-solicitud-designacion-jurado')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">
                            Generar solicitud
                        </a>
                    </div>
                </div>
                ...
                <div>
                    <x-input-label for='documento_path' value='Subir solicitud para la designación de Jurado(*) (PDF):' class="text-xs" />
                ...
                <div>
                    @php
                    use App\Models\Acta;
                    $acta7 = Acta::where('practica_id', Auth::user()->practicante->practica->id)
                    ->where('tipoacta_id', 7)
                    ->first();
                    @endphp
                    @if ($acta7 === null)
                    ...
                    <a target="_blank" href="{{route('practicante.ver-pdf-designacion-jurado',['name'=>$acta7->documento_path])}}">
        ...
        <div class="mt-5 flex items-center gap-4">
            ...
            @if (session('status') === 'savedDesignacion')
