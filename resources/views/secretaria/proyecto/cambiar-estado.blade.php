            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Cambiar estado o etapa</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-10">
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                    ...
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mt-4 mb-6">Algunos cambios de estado son automáticos, mientras
                        que en algunos casos tendrá que cambiarlo manualmente
                    </p>
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" action="{{route('proyecto.updateEstado',['proyecto' => $proyecto])}}" method="POST">
                                        ...
                                        <span class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-800 dark:text-gray-300">{{$proyecto->estado->name}}</span>
                                        @endif
                                        @if ($proyecto->estado_id == 2)
                                        <span class="bg-green-100 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">{{$proyecto->estado->name}}</span>
                                        @endif
                                        @if ($proyecto->estado_id == 3)
                                        <span class="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">{{$proyecto->estado->name}}</span>
                                        @endif
                                        @if ($proyecto->estado_id == 4)
                                        <span class="bg-indigo-100 text-indigo-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-indigo-900 dark:text-indigo-300">{{$proyecto->estado->name}}</span>
                                        @endif
                                        @if ($proyecto->estado_id == 5)
                                        <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">{{$proyecto->estado->name}}</span>
                                        @endif

                                        <div>
                                            <label for="estado" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Estados:</label>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                    ...
                    <ul class="w-full space-y-4 text-gray-500 list-none list-inside dark:text-gray-400">
                        ...
                        <li class="mb-2">
                            ...
                            @endif
                            @if ($item->id == 3)
                            <span class="bg-blue-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">
                                {{$item->name}}
                            </span>: {{$item->description}}
                            @endif
                            @if ($item->id == 4)
                            <span class="bg-blue-100 text-purple-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">
                                {{$item->name}}
                            </span>: {{$item->description}}
                            @endif
                            @if ($item->id == 5)
                            <span class="bg-blue-100 text-pink-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-pink-900 dark:text-pink-300">
                                {{$item->name}}
                            </span>: {{$item->description}}
                            @endif
                        </li>
                    ...
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mt-4 mb-6">Los cambios de etapa son automáticos, pero tamién puede modificarlos 
                        manualmente
                    </p>
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    ...
                                    <form class="space-y-6" action="{{route('proyecto.updateEtapa',['proyecto'=>$proyecto])}}" method="post">
                                        ...
                                        <span class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-800 dark:text-gray-300">{{$proyecto->etapa->name}}</span>
                                        @endif
                                        ...
                                        <div>
                                            <label for="etapa_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Etapas:</label>
