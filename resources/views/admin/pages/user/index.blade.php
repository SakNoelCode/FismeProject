        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            <header>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {{ __("Los usuarios son aquellos que pueden usar la aplicación, como tesistas, asesores o secretarías.") }}
                </p>
            </header>
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-1/2">
                            <form action="{{ route('usuarios.index') }}" class="flex items-center" method="get">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" value="{{$search}}" name="name-search" id="name-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Buscar por nombre">
                                </div>
                            </form>
                        </div>
                        <!----Acciones--->
                            ...
                            <div class="flex items-center space-x-3 w-full md:w-auto">
                                ...
                                <div id="actionsDropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                                        ...
                                        <li>
                                            <a href="{{route('asesores.create')}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Crear nuevo docente</a>
                                        </li>
                                        <li>
