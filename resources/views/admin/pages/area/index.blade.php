...
<h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
    {{ __('Módulo para la gestión de tipos de Areas') }}
</h2>
@endsection
@section('content')
<div class="py-6">
        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            <header>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {{ __("Define las áreas que tiene la Fisme.") }}
                </p>
            </header>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#btnCrearRegistro', function(event) {
            ...
            let ruta = "{{route('admin.area.store')}}";
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        $('#edit_description').val(response.data.descripcion);
                        openModalEdit();
                    }
                }
            });
    ...
    function fetchRegistros() {
        let ruta = "{{route('admin.area.fecth')}}"
        $.ajax({
            type: "get",
            url: ruta,
            dataType: "json",
                ...
                $.each(response.data, function(key, value) {
                    $('#tbody').append(
                        '<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">\
                            ...
                            <td class="px-6 py-4">' + (value.descripcion) + '</td>\
